...
import '../../core/exeptions/news_exeptions.dart';
...
class NewsRepositoryImpl implements NewsRepository {
  ...
  Future<List<NewsModel>> getTopHeadlines() async {
    try {
      ...
      throw NewsException('Failed to get top headlines,  maybe check the internet connection');
    }
  }
  ...
  Future<List<NewsModel>> getNewsByCategory(String category) async {
    try {
      ...
      throw NewsException('Failed to get news by category, maybe check the internet connection');
    }
  }
  ...
  Future<List<NewsModel>> searchNews(String query) async {
    try {
      ...
      throw NewsException('Failed to search news, maybe check the internet connection');
    }
  }
